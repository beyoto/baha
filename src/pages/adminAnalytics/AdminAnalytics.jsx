...
function AdminAnalytics() {
  ...
  useEffect(() => {
    api.get(`${API_PATHS.products}/admin/all`).then((res) => {
  ...
  useEffect(() => {
    ...
    let request;
    if (isComparing) {
      request = api.get(`${API_PATHS.analytics}/views-compare`, {
        params: { productIds: compareIds.join(','), range },
      });
    } else if (selectedProductId === 'all') {
      request = api.get(`${API_PATHS.analytics}/views-summary`, { params: { range } });
    } else {
      request = api.get(`${API_PATHS.analytics}/views`, { params: { productId: selectedProductId, range } });
    }
