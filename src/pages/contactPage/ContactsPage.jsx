      ...
      <div className="home-page">
        ...
        <main className="contacts-page__main">
          <div className="contacts-page__intro">
            ...
            <p>
              Хотите выбрать помолвочное кольцо, оформить заказ или узнать больше?
          ...
          <div className="contacts-page__grid">
            ...
            >
              ...
              <div className="contact-card__content">
                ...
                <p>
                  Смотрите новые кольца и бриллианты
                </p>
              </div>
          ...
          <div className="contacts-page__bottom">
            <p>
              Будем рады помочь выбрать кольцо для вашей истории ✦
            </p>
          </div>
        </main>
      </div>
