...
import { CATEGORY_LABELS, CURRENCY, formatPrice } from '../../constants/catalog.js';
import { STORE, WHATSAPP_URL } from '../../config/store.js';
import { productPath } from '../../config/api.js';
import { vehicleLabel } from '../../constants/vehicle.js';
      ...
      <div className="product-page__content">
        ...
        <div className="product-page__info">
          ...
          <div className="product-page__specs">
            {[['Год', product.year], ['Пробег', product.mileage ? `${product.mileage.toLocaleString()} км` : '—'], ['Двигатель', product.engine_volume], ['Коробка', vehicleLabel('transmission', product.transmission)], ['Топливо', vehicleLabel('fuel', product.fuel)], ['Привод', vehicleLabel('drive', product.drive)], ['Руль', vehicleLabel('steering', product.steering)], ['Состояние', vehicleLabel('condition', product.condition)], ['Цвет', product.color]].filter(([, value]) => value).map(([label, value]) => <span key={label}><b>{label}</b>{value}</span>)}
          </div>
