...
import { productImagesPath, productPath } from '../../config/api.js';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (newFiles.length > 0) {
        ...
        await api.post(productImagesPath(id), formData, {
          headers: {
          ...
          <div className="edit-product__fields">
            ...
            <label className="edit-product__field edit-product__field--full">
              ...
              <input
                ...
                placeholder="Например, кольцо с бриллиантом"
                required
              />
            </label>
